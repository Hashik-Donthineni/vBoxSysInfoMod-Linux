...
head /dev/urandom | tr -dc A-Za-z | head -c 13 | awk '{print "\""$1"\"" }' | VBoxManage setextradata "Windows10" "VBoxInternal/Devices/pcbios/0/Config/DmiSystemSerial" "Random Val"
head /dev/urandom | tr -dc A-Za-z | head -c 13 | awk '{print "\""$1"\"" }' | VBoxManage setextradata "Windows10" "VBoxInternal/Devices/pcbios/0/Config/DmiSystemSKU" "Random Val"
...
head /dev/urandom | tr -dc A-Za-z | head -c 13 | awk '{print "\""$1"\"" }' | VBoxManage setextradata "Windows10" "VBoxInternal/Devices/pcbios/0/Config/DmiBIOSVersion" "Random Val"
...
head /dev/urandom | tr -dc A-Za-z | head -c 13 | awk '{print "\""$1"\"" }' | VBoxManage setextradata "Windows10" "VBoxInternal/Devices/pcbios/0/Config/DmiBoardVersion" "Random Val"
head /dev/urandom | tr -dc A-Za-z | head -c 13 | awk '{print "\""$1"\"" }' | VBoxManage setextradata "Windows10" "VBoxInternal/Devices/pcbios/0/Config/DmiBoardSerial" "Random Val"
head /dev/urandom | tr -dc A-Za-z | head -c 13 | awk '{print "\""$1"\"" }' | VBoxManage setextradata "Windows10" "VBoxInternal/Devices/pcbios/0/Config/DmiBoardAssetTag" "Random Val"
